    ...
    <div className="p-5 space-x-0 lg:space-x-5 space-y-5 lg:space-y-0 block lg:flex justify-start items-start">
      <div className="flex-1 flex flex-col space-y-5">
        <div className="p-5 bg-white rounded border border-neutral-300">
          <h2 className="text-lg font-bold text-primary-800 mb-5">Basic</h2>
        ...
        <div className="p-5 bg-white rounded border border-neutral-300">
          <h2 className="text-lg font-bold text-primary-800 mb-5">With Icon</h2>
          <Alert
            className="mb-3"
            appearance="basic"
            color="primary"
      ...
      <div className="flex-1 flex flex-col space-y-5">
        <div className="p-5 bg-white rounded border border-neutral-300">
          <h2 className="text-lg font-bold text-primary-800 mb-5">Light</h2>
        ...
        <div className="p-5 bg-white rounded border border-neutral-300">
          ...
          <Alert className="mb-3" appearance="basic" color="dark" title="Dark">
            This is dark alert.
          </Alert>
          <Alert
            className="mb-3"
          ...
          <Alert className="mb-3" appearance="basic" color="info" title="Info">
            This is info alert.
          </Alert>
        </div>
      </div>
