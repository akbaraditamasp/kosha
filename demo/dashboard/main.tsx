import { Avatar, StatsCard } from "#kosha";
import {
  PiBookmarkDuotone,
  ...
  return (
    <>
      ...
      <div className="h-auto lg:h-[28rem] px-5 pb-5 block lg:flex justify-start items-stretch space-x-0 lg:space-x-5 space-y-5 lg:space-y-0">
        <div className="h-96 lg:h-full w-full lg:w-2/3 bg-white rounded border border-neutral-300 flex flex-col">
          <h3 className="text-lg font-bold p-5 text-primary-800">Statistics</h3>
        ...
        <div className="h-auto lg:h-full flex-1 bg-white rounded border border-neutral-300 flex flex-col">
          <h3 className="text-lg font-bold p-5 text-primary-800">
            Recent Activities
          </h3>
      ...
      <div className="px-5 pb-5 block lg:flex justify-start items-start space-x-0 lg:space-x-5 space-y-5 lg:space-y-0">
        <div className="w-full lg:w-1/2 bg-white rounded border border-neutral-300 pb-5">
          <h3 className="text-lg font-bold p-5 text-primary-800">
            Refferal URL
          </h3>
          <div className="flex flex-col">
        ...
        <div className="flex-1 bg-white rounded border border-neutral-300 pb-3">
          <h3 className="text-lg font-bold p-5 text-primary-800">
            This Weeks Stats
          </h3>
          ...
          <div className="p-5 text-sm font-ubuntu">
            <span className="font-semibold">Item List</span>
            <span className="text-neutral-700"> (3 items)</span>
          </div>
          <div className="px-5 py-3 flex justify-start items-center space-x-5">
