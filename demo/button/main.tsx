...
render("Button", ["Components", "Button"], () => {
  return (
    <>
      <div className="p-5">
        <div className="p-5 bg-white rounded border border-neutral-300">
          ...
          <div className="mb-5 pb-5 border-b border-neutral-200">
            ...
            <Button appearance="basic" color="secondary" className="mr-3 mb-3">
              Secondary
            </Button>
          ...
          <div className="mb-5 pb-5 border-b border-neutral-200">
            <Button appearance="rounded" color="primary" className="mr-3 mb-3">
              Primary
            </Button>
            <Button
              appearance="rounded"
            ...
            <Button appearance="rounded" color="warning" className="mr-3 mb-3">
              Warning
            </Button>
            <Button appearance="rounded" color="danger" className="mr-3 mb-3">
              Danger
            </Button>
            <Button appearance="rounded" color="success" className="mr-3 mb-3">
              Success
            </Button>
          ...
          <div className="mb-5 pb-5 border-b border-neutral-200">
            <Button appearance="outlined" color="primary" className="mr-3 mb-3">
              Primary
            </Button>
            <Button
              appearance="outlined"
            ...
            <Button appearance="outlined" color="warning" className="mr-3 mb-3">
              Warning
            </Button>
            <Button appearance="outlined" color="danger" className="mr-3 mb-3">
              Danger
            </Button>
            <Button appearance="outlined" color="success" className="mr-3 mb-3">
              Success
            </Button>
      ...
      <div className="p-5 pt-0 space-x-0 lg:space-x-5 space-y-5 lg:space-y-0 block lg:flex justify-start items-start">
        <div className="flex-1 flex flex-col space-y-5">
          <div className="p-5 bg-white rounded border border-neutral-300">
            <h2 className="text-lg font-bold text-primary-800 mb-5">Sizes</h2>
        ...
        <div className="flex-1 flex flex-col space-y-5">
          <div className="p-5 bg-white rounded border border-neutral-300">
            <h2 className="text-lg font-bold text-primary-800 mb-5">States</h2>
            <div>
              <Button
                icon={PiPencilBold}
                appearance="basic"
